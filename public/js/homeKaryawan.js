document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        const responsdataKaryawan = await fetch('/getNamaKaryawan', {
            method: 'GET',
            headers: {
        ...
        const tableBody = document.getElementById('table penilaian');
            ...
            dataKaryawan.data[0].dataDetailGenerate.forEach((karyawan, index) => {
                ...
                newRow.innerHTML = `
                    ...
                    ${karyawan.status === "belum selesai" ?
                        ...
                        <td id="aksi">
                            <a href="/formPenilaianPegawai/?id=${karyawan.id_detail_generate}">
