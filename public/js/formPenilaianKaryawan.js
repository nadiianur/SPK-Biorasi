document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        const responsdataKaryawan = await fetch(`/detailHasilNama/${id}`, {
            method: 'GET',
            headers: {
    ...
    try {
        const responsPertanyaan = await fetch('/penilaian/dataKriteria', {
            method: 'GET',
            headers: {
                'Content-type': 'application/json'
            }
        ...
        dataPertanyaan.data.forEach((pertanyaan, index) => {
            ...
            legend.classList.add('mt-4', 'fw-bold');
            ...
            label1.setAttribute('style', 'font-size: 100%; display: block;');
            ...
            input2.value = 4;
            label2.setAttribute('style', 'font-size: 100%; display: block;');
            ...
            input3.value = 3;
            label3.setAttribute('style', 'font-size: 100%; display: block;');
            ...
            input4.value = 2;
            label4.setAttribute('style', 'font-size: 100%; display: block;');
            ...
            label5.setAttribute('style', 'font-size: 100%; display: block;');
        ...
        submitButton.classList.add('btn', "btn-primary", "mt-4", "d-flex", "justify-content-center", "mx-auto");
        submitButton.textContent = 'Submit';
        submitButton.style.backgroundColor = '#488DF8';
        ...
        submitButton.addEventListener('click', async () => {
            try {
                ...
                if (isAllQuestionsAnswered) {
                    ...
                    const response = await fetch(`/penilaian/tambahPenilaian/${id}`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
